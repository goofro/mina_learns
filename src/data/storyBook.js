...
// page-8.jpg  → "The duckling approaching a beautiful lake where three graceful white swans are gliding on the shimmering water, children's book illustration style, vibrant colors, beautiful scene, no text, suitable for children ages 4 to 7"
// page-9.jpg  → "The duckling bending his head to the water and seeing the reflection of a beautiful white swan looking back at him, looking amazed, children's book illustration style, vibrant colors, no text, suitable for children ages 4 to 7"
// page-10.jpg → "A magnificent white swan gliding proudly on a lake with three other swans, children on the bank pointing and admiring, the swan looking joyful, children's book illustration style, vibrant colors, warm and joyful, no text, suitable for children ages 4 to 7"
//
// ─── momotaro ─────────────────────────────────────────────────────────────────
